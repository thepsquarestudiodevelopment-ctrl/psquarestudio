...
const targetContent = `          {/* td-team-area-start */}
          <div
            className="td-team-area td-team-about-wrap td-about-main-feature-area pb-165"
          >
            <div className="container">
              <div className="row td-team-section-row">
                ...
                <div className="col-lg-9 col-md-12">
                  <div className="td-team-bio-wrap mb-30">
                    <div className="td-team-bio-content">
                      <h3 className="td-team-bio-title mb-20">
                        About Our Creative Director
                      </h3>
                      <p className="td-team-bio-text mb-15">
...
const replacementContent = `          {/* td-team-area-start */}
          <div
...
if (content.includes(targetContent)) {
  ...
  // Keep original line endings style if needed, or save with LF (Vite/Git handles LF easily)
  fs.writeFileSync(filePath, content, "utf-8");
  console.log("About.jsx bio section successfully updated!");
} else {
  console.error("Target content not found in About.jsx!");
}
