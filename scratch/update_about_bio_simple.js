...
console.log("Rolling back to clean About.jsx...");
execSync("node scratch/convert_html_to_jsx.js", { stdio: "inherit" });
execSync("node scratch/fix_leading_slashes.js", { stdio: "inherit" });
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  const finalContent = before + replacementContent + after;
  fs.writeFileSync(filePath, finalContent, "utf-8");
  console.log("About.jsx bio section successfully updated!");
} else {
  console.error("Could not find start/end marks in About.jsx!", { startIndex, endIndex });
}
