    ...
    <>
      {/* td-hero-area-start */}
              ...
              <div className="row justify-content-center">
                <div className="col-lg-15">
                  <div className="td-hero-content">
                    ...
                    >
                      <h2 className="title">The Behind</h2>
                      <h2
                        className="title mb-0 d-flex align-items-center justify-content-center"
                      >
                        <img
                          className="mr-30 d-none d-sm-block"
                          src="/assets/img/hero/thumb.jpg"
                          alt=""
                        />
                        P<sup style={{ "fontSize": "60px" }}>2</sup>
                        <img
                          className="ml-35 d-none d-sm-block"
                          src="/assets/img/hero/thumb-2.jpg"
                          alt=""
                        />
                      </h2>
                      <h2 className="title">Passion X Precision</h2>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="col-12">
                  <div className="td-hero-bottom-thumb">
                    <video
                      ...
                      src="/assets/img/hero/showreel.mp4"
                      alt=""
                      autoPlay
                      loop
                      muted
                ...
                <div className="col-lg-8">
                  <div className="td-about-content mb-30">
                    <h2 className="td-about-title mb-30 td-text-invert">
                      Timeless design meets lasting impact. We craft brand
                      identities and stories that inspire with creativity and
                      precision.
                    </h2>
                    <p className="mb-45">
                      At The P Square Studio, creativity and precision come
                      together to craft refined, high-end brand experiences. We
                      specialize in premium design, cinematic motion graphics,
                      3D visuals, video production, and strategic digital
                      marketing. Every creation reflects elegance, intention,
                      and innovation because we don’t follow
                      trends; we set them.
                    </p>
                    ...
                    <div
                      className="td-about-thumb-wrap d-flex align-items-center justify-content-end"
                    >
              ...
              <div className="row align-items-end">
                <div className="col-lg-8">
                  <div className="td-service-6-title-wrap mb-30">
                    <span className="td-section-6-subtitle mb-20 d-inline-block"
                      >OUR SERVICES</span
                    >
                ...
                <div className="col-lg-4">
                  <div className="td-service-6-title-text mr-80 mb-35">
                    <p className="td-section-6-text mb-30">
                      Step Into the Square of Creativity. At The P Square
                      Studio, we craft visuals that define brands, inspire
                      audiences, and shape timeless experiences.
                    </p>
                    <p className="td-section-6-text">
                      Where art, motion, & technology converge. Because every
                      great vision deserves a flawless design.
                    </p>
                  </div>
                </div>
                <div className="col-12 pt-55">
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-5">
                        <div className="td-service-6-text mb-15">
                          <p>
                            We craft timeless designs and brand stories that
                            connect, inspire, and elevate your identity.
                          </p>
                        </div>
                      </div>
                      <div className="col-lg-2">
                        <div className="td-service-6-btn text-lg-center mb-15">
                          <Link to="/service-details-graphicdesign">
                            <svg
                              width="14"
                              height="14"
                              viewBox="0 0 14 14"
                  ...
                  <div className="td-service-6-item">
                    <div className="row">
                      <div className="col-lg-5">
                        <div className="td-service-6-item-title mb-15">
                          <span className="d-inline-block mr-80">02</span>
                          <h3>
                            Motion<br />
                            Ads
                          </h3>
                      ...
                      <div className="col-lg-5">
                        <div className="td-service-6-text mb-15">
                          <p>
                            Dynamic animations and motion ads that bring stories
                            to life and strengthen your digital presence.
                          </p>
                        </div>
                      </div>
                      <div className="col-lg-2">
                        <div className="td-service-6-btn text-lg-center mb-15">
                          <Link to="/service-details-motion">
                            <svg
                              width="14"
                              height="14"
                              viewBox="0 0 14 14"
                  ...
                  <div className="td-service-6-item">
                    <div className="row">
                      <div className="col-lg-5">
                        <div className="td-service-6-item-title mb-15">
                          <span className="d-inline-block mr-80">03</span>
                          <h3>
                            Video<br />
                            Editing
                          </h3>
                      ...
                      <div className="col-lg-5">
                        <div className="td-service-6-text mb-15">
                          <p>
                            Cinematic videos and brand films that connect
                            emotionally and inspire audiences.
                          </p>
                        </div>
                      </div>
                      <div className="col-lg-2">
                        <div className="td-service-6-btn text-lg-center mb-15">
                          <Link to="/service-details-videoediting">
                            <svg
                              width="14"
                              height="14"
                              viewBox="0 0 14 14"
                  ...
                  <div className="td-service-6-item">
                    <div className="row">
                      <div className="col-lg-5">
                        <div className="td-service-6-item-title mb-15">
                          <span className="d-inline-block mr-80">04</span>
                          <h3>
                            3D<br />
                            Architecture
                          </h3>
                      ...
                      <div className="col-lg-5">
                        <div className="td-service-6-text mb-15">
                          <p>
                            Transforming concepts into photorealistic 3D spaces
                  ...
                  <div className="td-service-6-item">
                    <div className="row">
                      <div className="col-lg-5">
                        <div className="td-service-6-item-title mb-15">
                          <span className="d-inline-block mr-80">05</span>
                          <h3>
                            CGI
                            {/* Architecture */}
                          </h3>
                      ...
                      <div className="col-lg-5">
                        <div className="td-service-6-text mb-15">
                          <p>
                            Imagination meets technology, with realistic,
                            artistic visuals from product to storytelling.
                          </p>
                        </div>
                      </div>
                      <div className="col-lg-2">
                        <div className="td-service-6-btn text-lg-center mb-15">
                          <Link to="/service-details-cgi">
                            <svg
                              width="14"
                              height="14"
                              viewBox="0 0 14 14"
                  ...
                  <div className="td-service-6-item">
                    <div className="row">
                      <div className="col-lg-5">
                        <div className="td-service-6-item-title mb-15">
                          <span className="d-inline-block mr-80">06</span>
                          <h3>
                            Digital <br />
                            Marketing
                            {/* Architecture */}
                      ...
                      <div className="col-lg-5">
                        <div className="td-service-6-text mb-15">
                          <p>
                            Blend creativity, analytics, & innovation to craft
                            digital campaigns that connect, engage, & convert.
                          </p>
                        </div>
                      </div>
                      <div className="col-lg-2">
                        <div className="td-service-6-btn text-lg-center mb-15">
                          <Link to="/service-details-digitalmarketing">
                            <svg
                              width="14"
                              height="14"
                              viewBox="0 0 14 14"
                  ...
                  <div className="td-service-6-item">
                    <div className="row">
                      <div className="col-lg-5">
                        <div className="td-service-6-item-title mb-15">
                          <span className="d-inline-block mr-80">07</span>
                          <h3>
                            Set <br />
                            Design
                            {/* Architecture */}
                      ...
                      <div className="col-lg-5">
                        <div className="td-service-6-text mb-15">
                          <p>
                            We craft your story into a balanced visual
                            experience, crafted with precision from concept to
                            final execution.
                          </p>
                        </div>
                      </div>
                      <div className="col-lg-2">
                        <div className="td-service-6-btn text-lg-center mb-15">
                          <Link to="/service-details-setdesign">
                            <svg
                              width="14"
                              height="14"
                              viewBox="0 0 14 14"
              ...
              <div className="row gx-0">
                ...
                >
                  <div className="td-service-process-item mt-120">
                    ...
                    <p className="para">Explore User Needs & Brand Opportunities</p>
                  </div>
                </div>
                <div
                  className="col-lg-3 col-md-6 col-sm-6 wow fadeInUp"
          ...
          <div className="td-portfolio-area pt-125">
            <h2
              className="td-portfolio-2-bigtitle td-split-text td-split-in-right"
            ></h2>
            <div className="td-portfolio-2-slider-wrap mb-10">
              <div className="swiper-container td-portfolio-2-slider">
                <div className="swiper-wrapper slide-transtion">
                  <div className="swiper-slide">
                    <div className="td-portfolio-2-item p-relative">
                      ...
                      <div className="td-portfolio-2-content">
                        ...
                        <a className="title" href="portfolio-details"
                          >Colyfate tent</a
                        >
                      </div>
                    </div>
          ...
          <div className="td-counter-area pt-155 pb-180">
            <div className="container">
              <div className="row align-items-end mb-70">
                <div className="col-lg-8">
                  <div className="td-service-6-title-wrap mb-30">
                    <span className="td-section-6-subtitle mb-20 d-inline-block"
                      >AWESOME FUNFACT</span
                    >
                    <h2 className="td-section-6-bigtitle td-text-opacity">
                      WHAT WE<br />
                      ARE ACHIEVE
                ...
                <div className="col-lg-4">
                  <div className="td-service-6-title-text mr-80 mb-35">
                    <p className="td-section-6-text mb-30">
                      We craft creative designs, motion graphics, 3D
                      experiences, and strategic digital marketing solutions
                      that engage audiences, strengthen brand identity, and
                      drive business growth.
                    </p>
                    <p className="td-section-6-text">
                      Every project is built with innovation, impact, and
                      SEO-focused results to help your brand stand out online.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-12">
                <div className="td-counter-6-wrap">
                  <div
                    className="td-counter-6-item wow fadeInLeft"
                    data-wow-delay=".3s"
                    data-wow-duration="1s"
                  >
                    <h3
                    ...
                    >
                      <span className="odometer" data-count="50">0</span>+
                    </h3>
                    <span className="text"
                      >Happy<br />
                      customers</span
                  ...
                  >
                    <h3
                      className="count d-flex align-items-center justify-content-center"
                    >
                      <span className="odometer" data-count="151">0</span>+
                    </h3>
                    <span className="text"
                      >Projects<br />
                      completed</span
                  ...
                  <div
                    className="td-counter-6-item wow fadeInRight"
                    data-wow-delay=".3s"
                    data-wow-duration="1s"
                  >
                    <h3
                      className="count d-flex align-items-center justify-content-center"
                    >
                      <span className="odometer" data-count="03">0</span>+
                    </h3>
                    <span className="text"
                      >Years of <br />
                      experience</span
