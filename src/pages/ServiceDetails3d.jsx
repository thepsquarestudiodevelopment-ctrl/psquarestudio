...
export default function ServiceDetails3d() {
  usePageInit();
                  ...
                  <div className="td-breadcrumb-wrap">
                    ...
                    >
                      <img
                        ...
                        src="/assets/img/service/hero/4/thumb-3.jpg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div className="row gx-0">
                ...
                >
                  <div className="td-service-process-item mt-120">
                    ...
                    <p className="para">
                      Understanding space, layout, materials, and architectural
                      plans.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="td-service-process-item">
                    ...
                    <p className="para">
                      Building 3D models, camera angles, and lighting that
                      define the space.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="td-service-process-item mt-120">
                    ...
                    <p className="para">
                      Enhancing textures, realism, and ambience with precision.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  <div className="td-service-process-item">
                    ...
                    <p className="para">
                      Photorealistic architectural renders for presentations,
                      marketing, and client approvals.
                    </p>
                  </div>
                </div>
              </div>
