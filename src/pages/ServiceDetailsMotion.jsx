...
export default function ServiceDetailsMotion() {
  usePageInit();
              ...
              <div className="row">
                  ...
                  <div className="td-breadcrumb-wrap">
                    ...
                    >
                      <img
                        ...
                        src="/assets/img/service/hero/2/thumb-2.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                ...
                <div className="col-lg-6">
                  <div className="td-service-hero-wrap">
                    ...
                    >
                      <p className="mb-40">
                        Our motion graphics services bring your ideas to life
                        with dynamic visuals and animations. We specialize in
                        animation, explainer videos, social media motion ads,
                        and interactive presentations to make your brand story
                        engaging and memorable.
                      </p>
                      <div className="td-service-hero-border mb-60"></div>
                      <div className="td-about-main-feature-list">
                        <ul>
                          <li>Motion Graphic Ads</li>
                          <li>Animated Social Media Posts</li>
                          <li>Explainer Animations</li>
                          <li>Kinetic Typography</li>
                          <li>Motion Design</li>
                          <li>Visual Effects (VFX) Integration</li>
                          <li>Motion Branding Elements</li>
                        </ul>
                      </div>
                    </div>
              ...
              <div className="row gx-0">
                ...
                >
                  <div className="td-service-process-item mt-120">
                    ...
                    <p className="para">
                      We identify your message, audience, and goals to define
                ...
                >
                  <div className="td-service-process-item">
                    ...
                    <h5 className="title mb-15">Design</h5>
                    <p className="para">
                      We craft storyboards and visual styles that shape the
                      narrative flow.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="td-service-process-item mt-120">
                    ...
                    <p className="para">
                      We animate graphics, typography, and elements with smooth,
                      engaging motion.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="td-service-process-item">
                    ...
                    <p className="para">
                      We provide polished motion ads and animations optimized
                      for all platforms.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-lg-10">
                  <div className="td-service-main-content mb-85">
                    <h2 className="td-text-invert">
                      Make every frame move <br /> with purpose.
                    </h2>
                  </div>
                </div>
                <div className="col-lg-4">
                  <div className="td-service-replace-shape pt-100 pb-30">
                    <img src="/assets/img/service/hero/2/shape.png" alt="" />
                  </div>
                </div>
                <div className="col-lg-8">
                  <div className="td-service-replace-content">
                    <div className="td-service-replace-thumb mb-50">
                      <img
                        className="td-rounded-10"
                        src="/assets/img/service/hero/2/thumb copy.jpg"
                        alt=""
                      />
                    </div>
                  </div>
