...
export default function ServiceDetailsSetDesign() {
  usePageInit();
      ...
      {/* td-service-hero-start */}
              ...
              <div className="row">
                  ...
                  <div className="td-breadcrumb-wrap">
                    ...
                    >
                      <img
                        ...
                        src="/assets/img/service/hero/7/thumb-2.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                ...
                <div className="col-lg-6">
                  <div className="td-service-hero-wrap">
                    ...
                    >
                      <p className="mb-40">
                        At The P Square Studio, Set Design isn't just building
                        spaces—it's creating experiences. We turn imagination
                        into immersive environments through thoughtful
                        composition, artistic direction, precise lighting, and
                        visual storytelling. Every set is crafted with clarity,
                        emotion, and creative geometry.
                      </p>
                    ...
                    <div className="td-service-hero-thumb fix td-rounded-10 pt-200">
                      <img
                        data-speed=".9"
                        className="td-rounded-10"
                        src="/assets/img/service/hero/7/thumb.png"
                        alt=""
                      />
                    </div>
                  </div>
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="td-service-description mb-60">
                    <p className="mb-30">
                      A well-designed set does more than decorate a scene; it
                      defines the mood, enhances the story, and elevates the
                      entire visual narrative.
                    </p>
                    <p className="mb-30">
                      From concept sketch to the final build, we craft sets that
                      reflect your brand's world and bring your vision to life
                      with artistic depth.
                    </p>
                    <p>
                      Whether it's for films, advertisements, photo shoots,
                      product videos, events, or digital productions, our set
                      designs are carefully crafted with intention and executed
                      with precision.
                    </p>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-xl-7">
                  <div className="td-service-2-title-wrap mb-60 td-title-anim">
                    ...
                    >
                    <h2 className="td-section-2-title d-inline-block">
                      OUR PROCESS - <span>HOW WE CREATE YOUR WORLD</span>
                    </h2>
                  </div>
                </div>
              </div>
              <div className="row gx-0">
                ...
                >
                  <div className="td-service-process-item mt-120">
                    ...
                    <h5 className="title mb-15">Discovery & Concept Direction</h5>
                    <p className="para">
                      We understand your story and shape it into clear concepts,
                ...
                >
                  <div className="td-service-process-item">
                    ...
                    <p className="para">
                      Your ideas become realistic 3D previews with accurate
                      scale, lighting, and layout.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  <div className="td-service-process-item mt-120">
                    ...
                    <h5 className="title mb-15">Set Construction & Styling</h5>
                    <p className="para">
                      Every element is crafted and styled with precision to
                ...
                >
                  <div className="td-service-process-item">
                    ...
                    <h5 className="title mb-15">
                      On-Site Execution & Final Touches
                    </h5>
                    <p className="para">
                      We build, refine, and perfect the set to ensure every
                      frame is cinematic and production-ready.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="col-lg-8">
                  <div className="td-service-replace-content">
                    <div className="td-service-replace-thumb mb-50">
                      <img
                        className="td-rounded-10"
                        src="/assets/img/service/hero/7/thumb copy.jpg"
                        alt=""
                      />
                    </div>
                  </div>
          ...
          <div className="td-service-process-area td-service-2-main-wrap pt-125">
            <div className="container">
              ...
              <div className="row">
                {/* Service 1: Film & Ad Set Design */}
                <div
                  className="col-12 wow fadeInUp mb-4"
                  data-wow-delay=".3s"
                  data-wow-duration="1s"
                >
                  <div className="service-horizontal-box p-4">
                    <div className="row">
                      <div className="col-md-3">
                        <h3 className="fw-bold">Film & Ad Set Design</h3>
                      </div>
                      <div className="col-md-9 position-relative">
                        <div className="divider-line"></div>
                        <p className="fst-italic mb-3">
                          Crafting cinematic spaces that elevate storytelling
                          and enhance visual emotion.
                        </p>
                        <div className="row">
                          <div className="col-md-6">
                            <ul>
                              <li>Script-based set concepts</li>
                              <li>Scene mood boards</li>
                              <li>Artistic direction & styling</li>
                            </ul>
                          </div>
                          <div className="col-md-6">
                            <ul>
                              <li>Full production design</li>
                ...
                {/* Service 2: Photoshoot & Product Set Design */}
                <div
                  className="col-12 wow fadeInUp mb-4"
                  data-wow-delay=".5s"
                  data-wow-duration="1s"
                >
                  <div className="service-horizontal-box p-4">
                    <div className="row">
                      <div className="col-md-3">
                        <h3 className="fw-bold">Photoshoot & Product Set Design</h3>
                      </div>
                      <div className="col-md-9 position-relative">
                        <div className="divider-line"></div>
                        <p className="fst-italic mb-3">
                          Designing picture-perfect environments that highlight
                          aesthetics, texture, and storytelling.
                        </p>
                        <div className="row">
                          <div className="col-md-6">
                            <ul>
                              <li>Creative set themes</li>
                              <li>Prop styling</li>
                              <li>Product staging</li>
                            </ul>
                          </div>
                          <div className="col-md-6">
                            <ul>
                              <li>Lighting concepts</li>
                              <li>Complete shoot setup</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                ...
                {/* Service 3: Event & Experience Set Design */}
                <div
                  className="col-12 wow fadeInUp mb-4"
                  data-wow-delay=".7s"
                  data-wow-duration="1s"
                >
                  <div className="service-horizontal-box p-4">
                    <div className="row">
                      <div className="col-md-3">
                        <h3 className="fw-bold">Event & Experience Set Design</h3>
                      </div>
                      <div className="col-md-9 position-relative">
                        <div className="divider-line"></div>
                        <p className="fst-italic mb-3">
                          Creating immersive spaces for exhibitions, events,
                          brand activations, and themed setups.
                        </p>
                        <div className="row">
                          <div className="col-md-6">
                            <ul>
                              <li>Event theme development</li>
                          ...
                          <div className="col-md-6">
                            <ul>
                              <li>Fabrication & installation</li>
                              <li>Brand experience setups</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                ...
                {/* Service 4: Virtual & CGI Set Design */}
                <div
                  className="col-12 wow fadeInUp mb-4"
                  data-wow-delay=".9s"
                  data-wow-duration="1s"
                >
                  <div className="service-horizontal-box p-4">
                    <div className="row">
                      <div className="col-md-3">
                        <h3 className="fw-bold">Virtual & CGI Set Design</h3>
                      </div>
                      <div className="col-md-9 position-relative">
                        <div className="divider-line"></div>
                        <p className="fst-italic mb-3">
                          When real spaces aren't enough, we create CGI-driven,
                          digital environments for videos, commercials, and
                          product showcases.
                        </p>
                        <div className="row">
                          <div className="col-md-6">
                            <ul>
                              <li>Virtual set design</li>
                              <li>CGI environments</li>
                              <li>Digital production assets</li>
                            </ul>
                          </div>
                          <div className="col-md-6">
                            <ul>
                              <li>Motion-compatible scenes</li>
                              <li>Hybrid CGI + Real Set design</li>
                            </ul>
                          </div>
                        </div>
                      </div>
          ...
          {/* OUR SET DESIGN SERVICES END */}

          {/* WHAT MAKES OUR SET DESIGN UNIQUE */}
          <div className="td-service-process-area td-service-2-main-wrap pt-125">
            <div className="container">
              <div className="row">
                <div className="col-xl-7">
              ...
              <div className="row gx-0">
                ...
                <div
                  ...
                  data-wow-duration="1s"
                >
                  <div className="td-service-process-item mt-30">
                    <h4 className="title mb-20">Design With Intent</h4>
                    <p className="para">
                      Every set is purposefully designed with narrative meaning,
                      ensuring each element contributes to the story being told.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="td-service-process-item mt-30">
                    <h4 className="title mb-20">Perfect the Frame</h4>
                    <p className="para">
                      We design with the camera in mind, ensuring every angle is
                      visually compelling and production-ready. <br /><br />
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="td-service-process-item mt-30">
                    <h4 className="title mb-20">Blend Creativity With Geometry</h4>
                    <p className="para">
                      Our sets merge artistic vision with structural precision,
                      creating environments that are both beautiful and
                      functional.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="td-service-process-item mt-30">
                    <h4 className="title mb-20">Deliver Cinematic Quality</h4>
                    <p className="para">
                      From concept to completion, we ensure every detail meets
                      the highest standards of visual storytelling and
                      performance.
                    </p>
                  </div>
                </div>
          ...
          {/* WHAT MAKES OUR SET DESIGN UNIQUE END */}
          <br />
          {/* td-cta-area-start */}
          <div className="container">
            <div className="row">
