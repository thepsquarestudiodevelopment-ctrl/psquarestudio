...
export default function ServiceDetailsVideoEditing() {
  usePageInit();
                  ...
                  <div className="td-service-hero-wrap">
                    ...
                    <div className="td-service-hero-thumb fix td-rounded-10 pt-200">
                      <img
                        data-speed=".9"
                        className="td-rounded-10"
                        src="/assets/img/service/hero/3/thumb.png"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div className="row gx-0">
                ...
                >
                  <div className="td-service-process-item mt-120">
                    ...
                    <p className="para">
                      Understanding your storyline, footage, and desired
                      emotional tone.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="td-service-process-item">
                    ...
                    <p className="para">
                      Structuring the edit with rhythm, pacing, and visual
                      style.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="td-service-process-item mt-120">
                    ...
                    <p className="para">
                      Adding transitions, sound design, color grading, and
                      effects for impact.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="td-service-process-item">
                    ...
                    <p className="para">
                      Smooth, polished videos optimized for web, ads, and
                      campaigns.
                    </p>
                  </div>
                </div>
